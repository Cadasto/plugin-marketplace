...
| [go-coding-plugin](https://github.com/Cadasto/go-coding-plugin)                  | Idiomatic Go coding standards for AI assistants (formatting, errors, concurrency, testing, layout) |
